...
INIT_BOARD_PATTERN = {
    U.P1:{[(-2,1), (-1,3), (0,2), (1,3), (2,1)]}, # (relative azim, number of pieces)
    U.P2:{[(-2,1), (-1,3), (0,2), (1,3), (2,1)]}
 } 

NUM_TOKENS_PER_PLAYER = {
    U.P1: sum([a[1] for a in INIT_BOARD_PATTERN[U.P1]])+1, #Get the number of tokens per player, plus 1 for the seeker
    U.P2: sum([a[1] for a in INIT_BOARD_PATTERN[U.P2]])+1 #Get the number of tokens per player, plus 1 for the seeker
    }
